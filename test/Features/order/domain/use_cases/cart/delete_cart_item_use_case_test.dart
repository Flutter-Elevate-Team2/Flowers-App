...
void main() {
  ...
  setUp(() {
    ...
    deleteCartItemUseCase = DeleteCartItemUseCase(mockOrderRepoContract);
  });
  ...
  test(
    "should call DeleteCartItemUseCase.call() and return SuccessResponse",
        () async {
      when(
        mockOrderRepoContract.deleteFromCart("123"),
      ...
      verify(mockOrderRepoContract.deleteFromCart("123")).called(1);
    },
  );
}