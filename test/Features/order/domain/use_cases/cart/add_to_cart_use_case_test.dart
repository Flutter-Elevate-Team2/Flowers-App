...
void main() {
  ...
  setUp(() {
    ...
    addToCartUseCase = AddToCartUseCase(mockOrderRepoContract);
  });
  ...
  test(
    ...
    () async {
      when(
        mockOrderRepoContract.addToCart(cartRequest),
      ...
      verify(mockOrderRepoContract.addToCart(cartRequest)).called(1);
    },
  );
}
