...
class ProductCard extends StatelessWidget {
  ...
  BoxDecoration _buildContainerBoxDecoration(BuildContext context) {
    return BoxDecoration(
          ...
          border: Border.all(color: Theme.of(context).colorScheme.surfaceContainerHighest , width: .5),
          boxShadow: [
            BoxShadow(
  ...
  Column _buildProductCard(BoxConstraints constraints, double screenWidth, BuildContext context) {
    return Column(
  ...
  Padding _buildPriceRow(BoxConstraints constraints, double screenWidth, BuildContext context) {
    return Padding(
